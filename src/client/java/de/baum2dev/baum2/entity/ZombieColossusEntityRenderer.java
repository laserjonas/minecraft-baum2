 ...
 * <ul>
 *   <li>Reuses vanilla's own {@link ZombieEntityRenderState} unchanged (no bespoke render-state
 *   subclass needed - see {@link ZombieColossusEntityModel}'s javadoc for why).</li>
...
public class ZombieColossusEntityRenderer
        extends MobEntityRenderer<ZombieColossusEntity, ZombieEntityRenderState, ZombieColossusEntityModel> {
    ...
    @Override
    public void updateRenderState(ZombieColossusEntity entity, ZombieEntityRenderState state, float tickDelta) {
        super.updateRenderState(entity, state, tickDelta);
        // Populates equippedHeadStack/rightHandItem/arm poses/etc. from the entity's actual
        // equipment - BipedEntityRenderer normally does this internally on every updateRenderState
        // call, but this class no longer extends BipedEntityRenderer (see class javadoc), so it's
        // invoked directly, same as GiantEntityRenderer does.
