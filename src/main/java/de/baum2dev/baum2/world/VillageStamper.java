...
public final class VillageStamper {
     ...
     * generated by tools/gen_village.py (91x91 template; its center cell (45,45) must land
     * on world (0,0), hence the -45 origin). Regenerate with
    ...
    private static final List<TemplatePlacement> TEMPLATES = List.of(
            new TemplatePlacement(
                    ...
                    new BlockPos(-45, ZoneLayout.CLEARING_SURFACE_Y, -45))
    );
